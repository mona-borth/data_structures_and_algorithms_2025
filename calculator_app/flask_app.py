...
@app.route('/calculate', methods=['POST'])  # associating the POST method with this route (there is also "GET")
def calculate():
    ...
    if operation == 'addition':
        ...
        return render_template('index.html', printed_result='Operation must be "addition" or "subtraction" or "division"')
